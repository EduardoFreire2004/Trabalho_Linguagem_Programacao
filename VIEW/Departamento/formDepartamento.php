...
<head>
    ...
    <?php include_once 'C:\xampp\htdocs\projeto-escolar-php\BLL\Departamento.php' ?>
...
<body>
    ...
    <div class="container grey lighten-3 white-text col s12">
        ...
        <div class="row  black-text">
            <form action="insDepartamento.php" method="POST" class="col s12">
                ...
                <div class="brown lighten-3 center col s12">
                    ...
                    <button class="waves-effect waves-light btn blue" type="button"
                        onclick="JavaScript:location.href='lstDepartamento.php'">
